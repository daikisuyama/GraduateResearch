...
単色の音色変換であっても任意の高さと大きさの音を学習データとして用意するのは不可能である。よって、汎化能力を調査する必要がある。ここでは、88音のうち3/4を学習データ、1/4を評価データとする4分割交差検定を行った。また、データセットの分割方法は付録の\ref{sec:appendix_split}節に示す。
