...
生成モデルの汎化能力を調べた際のデータセットの区分を表\ref{tab:split}に示す。

%国際の階名表記に従っているが、正確にはアルフベットは大文字でsは\#を示す。
%音階順でソート(アルファベット)
%アルファベット#数字の表記に変える
\begin{table}[h]
\label{tab:split}
...
\begin{center}
    ...
    \begin{tabular}{l|llllllllllllllllllllll}\toprule
        ...
        3 & b4 & f3s & f6s & e2 & b1 & e5 & f2 & c3 & a4s & f1 & c6 & a7 & d2 & g6s & g2s & g3s & c3s & f4s & a0 & d7 & b3 & c7 \\ \bottomrule
    \end{tabular}
    }
\end{center}
\end{table}